                ...
                <form method="POST" action="{{ route('items.store') }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="kode_barang" value="{{ old('kode_barang') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                            @error('kode_barang')<div class="text-red-600 text-sm mt-1">{{ $message }}</div>@enderror
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Nama Barang</label>
                            <input type="text" name="nama_barang" value="{{ old('nama_barang') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                            @error('nama_barang')<div class="text-red-600 text-sm mt-1">{{ $message }}</div>@enderror
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Satuan</label>
                            <input type="text" name="satuan" value="{{ old('satuan') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                        ...
                        <div>
                            ...
                            <input type="number" name="stok_minimal" value="{{ old('stok_minimal', 0) }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" min="0" >
                        ...
                        <div>
                            ...
                            <input type="number" name="stok_sekarang" value="{{ old('stok_sekarang', 0) }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" min="0" >
