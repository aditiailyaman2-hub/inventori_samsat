    ...
    <div class="py-6">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm rounded-lg p-6">
                <form method="POST" action="{{ route('transactions.outs.store') }}">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <select name="item_id" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                            ...
                            @foreach($items as $item)
                                <option value="{{ $item->id }}">{{ $item->kode_barang }} - {{ $item->nama_barang }} (Stok: {{ $item->stok_sekarang }})</option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="jumlah_keluar" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" min="1" value="{{ old('jumlah_keluar') }}" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" name="tanggal_keluar" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" value="{{ old('tanggal_keluar') }}" required>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="penerima" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" value="{{ old('penerima') }}" required>
